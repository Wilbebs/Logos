...
export default function AIRecommendation({ applicant, onReviewComplete }) {
  // Bypass cases (eligible/ineligible) are determined by the rules engine, not Gemini
  const isRulesEngineResult = applicant.eligibility_status === 'eligible' || applicant.eligibility_status === 'ineligible';
  const aiSourceLabel = isRulesEngineResult ? 'Evaluated by LOGOS Eligibility Engine' : 'Generated by Gemini AI';
