...
export default function AcceptanceLetterPage() {
  ...
  // ── Compose ─────────────────────────────────────────────────────────────────
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col" style={{ paddingBottom: 'calc(var(--timeline-bar-height, 0px) + 1.5rem + 25px)' }}>
      ...
      <div className="max-w-5xl mx-auto w-full px-4 sm:px-6 py-6 gap-4 flex flex-col">
